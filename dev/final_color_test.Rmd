...
```{r}
new_cols <- c("#000000", qualFillColors(2, rev_colors = T)) %>% set_names(c("overall","grad", "undergrad"))
...
### Reversed color palette with 7 categories in horizontal bar chart to show bottome colors:
