...
- Start of new vignette: `Import and Clean Data using blackstone` name file: 'import_clean.Rmd'
...
- end of vignette `Import and Clean Data using blackstone` 

# Data analysis and Statistical Inference

- Start of new vignette: `Data analysis and Statistical Inference using blackstone` name file: 'analysis.Rmd'
...
- End vignette: `Data Visualization using blackstone` name file: 'data_visualization.Rmd'
