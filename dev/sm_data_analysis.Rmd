...
- By default, `arrowChartGroup()` sorts the items/arrows by the ones with the highest post average on down and the arrows are the dark blue color hex code `r blackstoneColors[["dark_blue"]]`.
