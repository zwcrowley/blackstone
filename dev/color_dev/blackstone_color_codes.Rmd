...
ggplot2::ggplot(data.frame(id = rev(seq_along(colors)), color = rev(colors))) + 
  ggplot2::geom_col(ggplot2::aes(y = 1, x = id, fill = rev(colors))) + 
...
### Blackstone Dark Blue `r blackstone::blackstoneColors["dark_blue"]`
...
### Qualitative Color Palette with names and hex codes:
