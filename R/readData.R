#' Create Codebooks and Read in Data with New Names from SurveyMonkey
#'
#' @description
#'
...
#'
#' @return A [tibble][tibble::tibble-package] with the data in 5 columns: `question_name`, `full_text`, and `full_question_text`.
