...
If you have completed the above steps, the settings should resemble figure 4.5 below and you can proceed to click '**Create Project**' in the lower-right corner. This will launch the new Project named 'analysis\_{Your Initials}'
...
Un-comment and run the code below to open the example project in a new `RStudio` instance and then open `report.Rmd` by copying the next line of code into the console in the new `RStudio` instance:
