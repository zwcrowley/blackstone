...
[^readr]: The code below uses the `readr` package, if it is not installed, install it with: `install.packages("readr")`
...
Un-comment and run the code below to open the example project in a new `RStudio` instance and then open `report.Rmd` by copying the next line of code into the console in the new `RStudio` instance:[^rstudioapi]

[^rstudioapi]: The code below uses the `rstudioapi` package, if it is not installed, install it with: `install.packages("rstudioapi")`
