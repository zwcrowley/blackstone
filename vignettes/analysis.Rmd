...
```{r demos_table, fig.alt: "Example of using `groupedTable()` to make a demographics table"}
...
```{r demos_table_role , fig.alt: "Example of using `groupedTable()` to make a grouped demographics table"}
