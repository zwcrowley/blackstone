...
Now, we can use `here()` to build relative paths to read and write data.
...
```{r}
# Setting up file path the the Data folder for Year 4:
data_year4_fp <- here("../../../Data/Year4_(2023-2024)")
data_year4_fp
```
