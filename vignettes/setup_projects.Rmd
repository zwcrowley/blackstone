...
This vignette will go over best practices for using `R` and `RStudio` for Blackstone Research and Evaluation (`BRE`). This will include:
...
There are two ways to do this: either run `usethis::use_blank_slate()` or in `RStudio` go to the top menu bar and select Tools, then Global Options, General settings and make sure the `Workspace` section looks like the figure below: 
...
Re-run your code to ensure it includes everything necessary to complete the data tasks.
