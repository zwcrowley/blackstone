...
The vignette `Import and Clean Data using blackstone` goes into deeper detail with example data on how to use `blackstone` to import and clean data.


## Data Analysis and Statistical Inference

First, read in the data that is merged and cleaned in the vignette `Import and Clean Data using blackstone`:
