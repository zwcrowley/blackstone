...
### 2. Editing the codebook to create meaningful variable names
...
Finally, it is important to add pre and post prefixes to all variables that will be merged, (i.e. the survey items that differ pre-post- the SM items and demos are identical):
...
```{r, include=FALSE}
# TODO add link to R package below for `dplyr`
```
