...
On the initial installation (or after upgrading R) you will also have to
install and import fonts from the
[`extrafont`](https://github.com/wch/extrafont) package:
