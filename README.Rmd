...
**df** Required, a tibble or data frame of survey items that are numeric variables, in anywhere from 3 to 7 point scales, can be a single time point or pre-post.
