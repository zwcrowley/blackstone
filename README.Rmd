...
On the initial installation you will also have to install and import fonts from the `extrafont` package:
...
Here is just one use for `bre` that creates a stacked bar chart of pre-post data:
...
If you encounter a clear bug or need any help with this package, please reach out to me on the Google Chat space, direct message me or email. 
